...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-sm-12">
        ...
        <a type="button" class="btn btn-primary btn-lg" href="PagesSingle.aspx">Create Page
        </a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:Button runat="server" ID="btnCreateCategory" CssClass="btn btn-primary" Text="Create category" OnClick="btnCreateCategory_OnClick" />
